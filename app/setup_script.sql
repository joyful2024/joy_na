...
-- create the application role aop_public
...
-- add an streamlit app
CREATE STREAMLIT IF NOT EXISTS code_schema.hello_joy_streamlit
  FROM '/streamlit'
  MAIN_FILE = '/hello_joy.py'
;
GRANT USAGE ON STREAMLIT code_schema.hello_joy_streamlit TO APPLICATION ROLE app_public;